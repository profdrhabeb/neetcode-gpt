...
class Solution:
    ...
    def get_loss(self, prediction: TensorType[float], target: TensorType[float]) -> TensorType[float]:
        ...
        answer = torch.nn.functional.mse_loss(prediction, target)
        return torch.round(answer, decimals=4)